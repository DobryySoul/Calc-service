...
```json
{
    "expression": "аримфметическое выражение верного формата" -> string
}
```
...
```json
{
    "id": "идентификатор задачи", -> int
    "result": "валидный формат ответа" -> int
}
```
...
{
    "id": "идентификатор задачи", -> int
    "result": "невалидный формат результата" -> string
}
```
